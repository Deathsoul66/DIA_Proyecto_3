...
{
	public class vistaFiltroPublicacion : Window
	{
		...
		public vistaFiltroPublicacion() : base("Tabla Filtro")
		{
			Autor = "";
			Anho = "";
			Tipo = "";
            this.listaP = XMLreader.devolverXML();
			Build();
		}
		...
		private void OnClickBuscar(object o, EventArgs e) {
			...
			listaPublicacion listaFilt = XMLreader.devolverXML();
			this.listaP = XMLreader.filtrarLista(listaFilt, this.Autor, this.Anho, this.Tipo);
		...
		private void OnClickQuit(object o, EventArgs e) { this.Hide();}
