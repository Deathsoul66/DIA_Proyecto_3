...
namespace ViajesIU.View
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private ScrolledWindow BuildTable()
        {
            ...
            telefono.AddAttribute(telefonoCell, "text", 3);
            ...
            email.AddAttribute(emailCell, "text", 4);
            ...
            direccion.AddAttribute(direccionCell, "text", 5);
            tvDatos.AppendColumn(direccion);

            ls = new ListStore(typeof(int), typeof(string), typeof(string), typeof(string), typeof(string), typeof(string));
            //ActualizarDatos ();
            tvDatos.Model = ls;
